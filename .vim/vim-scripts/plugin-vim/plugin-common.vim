...
"call dein#add('SailorCrane/SearchComplete')
...
"31 YankRing
 ...
 call dein#add('SailorCrane/YankRing.vim')
...
" yank highlight
"call dein#add('machakann/vim-highlightedyank.git')
...
"32 color view
call dein#add('http://git.oschina.net/CraneAgain/xterm-color-table.vim')
...
"call dein#add('Tuxdude/mark.vim')
...
"call dein#add('AutoFold.vim')


" 65 drawit: 使用vim draw文本图.
call dein#add('hrj/vim-DrawIt')
...
call dein#add('SailorCrane/ToggleIsk')
...
" 30
"call dein#add('vim-scripts/Fortune-vimtips')
"call dein#add('vim-scripts/fortune.vim')
