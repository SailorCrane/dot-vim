...
nnoremap  <Leader>eb  :vsplit  $Vim_Scripts/myBundle-plugins-settings-and-source.vim<CR>
...
nnoremap  <Leader>ea  :vsplit   $Crane_Sh_Dir/alias-dir/python-pip-pipenv-alias.sh<CR>
