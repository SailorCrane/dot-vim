...
if !maparg('<C-h>', 'n')
    nnoremap <unique> <C-h>  <C-w>h:ShowBufName<CR>
    nnoremap <unique> <C-l>  <C-w>l:ShowBufName<CR>
    nnoremap <unique> <C-j>  <C-w>j:ShowBufName<CR>
    nnoremap <unique> <C-k>  <C-w>k:ShowBufName<CR>
endif
