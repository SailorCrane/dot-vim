...
set dictionary+=$Crane_Vim_Dict/words,$Crane_Vim_Dict/words_ch.txt,$Crane_Vim_Dict/custome_words.txt
...
"{{{
" 将source移动到最后
" source ~/.vim/vim-scripts/myBundle-plugins-settings-and-source.vim
" 注意这里如果要编辑, 只能使用<Leader>e 前缀编辑, 无法通过gf跳转.
source  $Vim_Scripts/myBundle-plugins-settings-and-source.vim
...
source  $Vim_Scripts/local-custom-no-git.vim
